...
description: rtdl contribution guide
---

# rtdl Contribution Guide 😎
Thank you for investing your time in contributing to rtdl. Contributions are always welcome!  
See our [CONTRIBUTING](https://github.com/realtimedatalake/rtdl/blob/main/CONTRIBUTING.md) 
for ways to get started.

## Code Of Conduct

This project adheres to the rtdl [code of conduct](https://github.com/realtimedatalake/rtdl-docs/blob/main/CODE_OF_CONDUCT.md) - 
...
(see the [LICENSE file](https://github.com/realtimedatalake/rtdl/blob/main/LICENSE)).
The MIT license allows you to freely use, modify, distribute, and sell your 
own products that include MIT licensed software.
