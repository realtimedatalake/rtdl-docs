...
writing in the Delta Lake table format as well as integration with the [AWS Glue](https://aws.amazon.com/glue/) 
and [Snowflake External Tables](https://docs.snowflake.com/en/user-guide/tables-external-intro.html) 
metadata catalogs.
